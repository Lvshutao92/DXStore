...
//  DXStore
//
//  Created by ilovedxracer on 2018/9/5.
//  Copyright © 2018年 吕书涛. All rights reserved.
//

import UIKit

class ToolObj: NSObject {
    ...
    /// 导航栏高度
    lazy var kNavigationbarHeight = (kStatusBarHeight+44.0)
    /// Tab高度
    lazy var kTabBarHeight = kStatusBarHeight > 20 ? 83 : 49
    
    /// 屏幕比率
    lazy var kScreenWidthRatio = (kScreenWidth/375.0)
    /// 调整
